$downloadURL = "https://github.com/ozgur-yalcin/mfa/releases/latest/download/mfa_Windows_x86_64.zip"
$packageName = "mfa_Windows_x86_64.zip"
...
# $Destination = "$env:USERPROFILE\Packages\mfa"
...
Write-Host "mfa has been installed at $Destination" -ForegroundColor Green
