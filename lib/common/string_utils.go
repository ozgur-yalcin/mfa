...
func StringUtils_guessEncoding(bytes []byte, hints map[lib.DecodeHintType]interface{}) (string, error) {
...
func StringUtils_guessCharset(bytes []byte, hints map[lib.DecodeHintType]interface{}) (encoding.Encoding, error) {
	if hint, ok := hints[lib.DecodeHintType_CHARACTER_SET]; ok {
