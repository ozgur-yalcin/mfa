...
func NewAlignmentPatternFinder(image *scan.BitMatrix, startX, startY, width, height int, moduleSize float64, resultPointCallback scan.ResultPointCallback) *AlignmentPatternFinder {
...
func (this *AlignmentPatternFinder) Find() (*AlignmentPattern, scan.NotFoundException) {
	startX := this.startX
	height := this.height
